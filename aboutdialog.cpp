    ...
    ui(new Ui::aboutDialog)
{
    ...
    ui->creditsTextArea->setText("<b>Developers</b><br>Commercial - ICS<br>Lead - Dylan Coakley<br><br><b>Graphics</b><br>Website graphics - Raqasa<br>Application icons - Attari B<br><br><b>Promotional Media</b><br>Art Designer - Catherine Fister<br>Advertising - Don Murphy<br><br><b>Contributors</b><br>Duzy Chan - Code<br>Samuel Cowen - Code<br>Richard Senior - GNU Autotools<br>Alexandre Kharlamov - Code<br>Michael Sheppard - Code<br>Helene Levernieux - Project Icon<br><br><b>Special thanks</b><br>I would to thank Catherine for her strong support of myself and the project over the years. You gave me the courage to keep going and accomplish my goals.");


    ui->appName->setText("PhotoFiltre LX Studio");
    QFont font;
    font.setPointSize(14);
    ui->appName->setFont(font);
    ui->appVersion->setText("0.0.1");
    ui->appDescription->setText("A simple but featureful editor.");
    ui->appUrl->setText("<a href='http://www.photofiltre-lx.org'>http://www.photofiltre-lx.org</a>");
