    ...
    d(new BatchDialogPrivate)
{
    ...
    filters << tr("Auto levels");
    filters << tr("Auto contrast");
    filters << tr("Crop to center");
    filters << tr("Equalize colours");
    filters << tr("Monochrome edges");
    filters << tr("Pixelate");
    filters << tr("Vignette");
    filters << tr("Posterize");
    filters << tr("Pixel Scatter");
    filters << tr("Gaussian noise");
    filters << tr("Impulse noise");
    filters << tr("Laplacian noise");
    filters << tr("Poisson noise");
    filters << tr("Dust Reduction");
    filters << tr("Despeckle");
    filters << tr("Trim");
